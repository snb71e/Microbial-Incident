# Mars Base BSL-4 Microorganism Leak Simulation 🪐🦠

**Computational Physics Term Project (Spring 2026)**
...
Following the **Planetary Protection Policy** established by the Committee on Space Research (COSPAR), this project simulates a hypothetical scenario: an aerosolized microorganism leak within a Biosafety Level 4 (BSL-4) research facility on a Mars base.

## 🎯 Objectives
The goal of this project is to answer a fundamental physics question regarding planetary protection:
> *"In the event of an extreme containment breach, how would airborne particles diffuse throughout the base?"*

## 🔬 Methodology & Physics Models
